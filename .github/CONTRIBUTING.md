...
1. Check if the bug has already been reported in [Issues](https://github.com/mpiton/vortex/issues)
2. If not, create a new issue using the **Bug Report** template
3. Include steps to reproduce, expected behavior, and actual behavior

### Suggesting Features

1. Check existing [Feature Requests](https://github.com/mpiton/vortex/issues?q=label%3Aenhancement)
...
Open a [Discussion](https://github.com/mpiton/vortex/discussions) or file an issue using the **Question** template.
