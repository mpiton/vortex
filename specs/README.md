...
- [ ] [`02-ci-quality-gates.md`](01-mvp/02-ci-quality-gates.md) — CI pipeline + lefthook pre-commit/pre-push + GitHub Actions + templates
- [ ] [`03-domain-models.md`](01-mvp/03-domain-models.md) — Entites domaine, state machine, events, errors, value objects
