...
pub use adapters::driving::tauri_ipc::{
    ...
    download_open_file, download_open_folder, download_pause, download_pause_all,
    download_redownload, download_remove, download_resume, download_resume_all, download_retry,
