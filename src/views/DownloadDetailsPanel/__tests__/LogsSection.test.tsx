...
describe("LogsSection", () => {
  ...
  it("should display log lines", async () => {
    ...
    vi.mocked(invoke).mockResolvedValue(["[INFO] Download started", "[INFO] Connected to server"]);
  ...
  it("should refetch logs while the panel stays open", async () => {
    ...
    expect(await screen.findByText("[INFO] Segment 1 completed")).toBeInTheDocument();
  }, 7000);
});
