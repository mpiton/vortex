...
describe('FilterBar', () => {
  it('should render all filter tabs', () => {
    render(
      <FilterBar activeFilter="all" onFilterChange={vi.fn()} counts={mockCounts} />,
    );
  ...
  it('should call onFilterChange when tab is clicked', async () => {
    ...
    render(
      <FilterBar activeFilter="all" onFilterChange={onChange} counts={mockCounts} />,
    );
  ...
  it('should handle undefined counts gracefully', () => {
    render(
      <FilterBar activeFilter="all" onFilterChange={vi.fn()} counts={undefined} />,
    );
    expect(screen.getByText('All')).toBeInTheDocument();
  });
});
