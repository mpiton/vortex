...
describe('PeriodSelector', () => {
  it('moves selection right on ArrowRight', async () => {
    ...
    render(
      <PeriodSelector value="7d" onChange={onChange} ariaLabel="period" labels={labels} />,
    );
  ...
  it('wraps from last to first on ArrowRight', async () => {
    ...
    const onChange = vi.fn();
    render(
      <PeriodSelector value="all" onChange={onChange} ariaLabel="period" labels={labels} />,
    );
  ...
  it('moves selection left on ArrowLeft', async () => {
    ...
    const onChange = vi.fn();
    render(
      <PeriodSelector value="30d" onChange={onChange} ariaLabel="period" labels={labels} />,
    );
