      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b text-left text-xs font-medium text-muted-foreground">
            <th scope="col" className="px-3 py-2">{t('history.columns.name')}</th>
            <th scope="col" className="px-3 py-2">{t('history.columns.host')}</th>
            <th scope="col" className="px-3 py-2">{t('history.columns.size')}</th>
            <th scope="col" className="px-3 py-2">{t('history.columns.duration')}</th>
            <th scope="col" className="px-3 py-2">{t('history.columns.completedAt')}</th>
            <th scope="col" className="px-3 py-2">{t('history.columns.status')}</th>
            <th scope="col" className="px-3 py-2">{t('history.columns.avgSpeed')}</th>
            <th scope="col" className="px-3 py-2">{t('history.columns.module')}</th>
            <th scope="col" className="px-3 py-2">{t('history.columns.account')}</th>
